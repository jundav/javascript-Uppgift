(function($) {
  ...
  $(function() {
    ...
    var areaData = {
      ...
      document.getElementById('userStat').innerHTML=data.users
      document.getElementById('userIncrease').innerHTML=data.growth + "%"
  ...
  var areaData = {
      ...
      document.getElementById('userProject').innerHTML=data.projects
